...
// GetRandomSatisfiedChannelExcluding selects a channel while omitting channel IDs
// that are temporarily unsuitable for this model. The original selector remains
// the public compatibility wrapper so upstream merges stay localized.
